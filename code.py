...
import os
root = tk.Tk()
root.title("Inventory and Stock Management System with Billing Section")
tabcontrol = ttk.Notebook(root)
Inventory = ttk.Frame(tabcontrol)
labelFrame = ttk.LabelFrame(Inventory,text="Inventory Management System")
...
labelFrame1 = ttk.LabelFrame(Inventory,text="List of Products",borderwidth=3)
...
tree = ttk.Treeview(labelFrame1, columns=('Product ID No.', 'Name of Product','Selling Price','Quantity Sold'),height=20)
...
tree.heading('#1', text='Product ID No.')
tree.heading('#2', text='Name of Product')
tree.heading('#3', text='Selling Price')
tree.heading('#4', text='Quantity Sold')
...
productPrice = ttk.Label(labelFrame,text="Selling Price : ")
...
productQuantity = ttk.Label(labelFrame,text="Quantity Sold : ")
...
ShowButton = ttk.Button(labelFrame,text='Status',command=Get_data)
...
tabcontrol.add(tab2,text="Billing Section")
tabcontrol.pack(expand=1,fill="both")
#****************************************************************
...
Billing_PRODUCT_QUANTITY = ttk.Label(BillingFrame,text="Quantity Sold :")
...
Billing_PRODUCT_Price = ttk.Label(BillingFrame,text="Price per item :")
...
Billing_Show_Button = ttk.Button(BillingFrame,text="Cart View",command=Bill_show)
...
labelFrame2 = ttk.LabelFrame(tab2,text="List of Products",borderwidth=3)
#labelFrame1.grid_propagate(0)
...
tree1.heading('#2', text='Name of Product')
tree1.heading('#3', text='Selling Price')
